Vue.component('Services', {
    ...
    <article class="services">
        <div class="curve">
            ...
            <div class="bottom" style="height: 150px; overflow: hidden;"><svg viewBox="0 0 500 150"
                ...
                <img v-for="i in 2" src="./assets/img/geometry/box-black.png" alt="Circles box black">
        </div>

        <div class="content">
            <div class="container my-5">
                <div class="row">
                    <div v-for="image in images" class="col-md-4 col-sm-12 d-flex flex-column align-items-center">
    ...
    data(){
        return {
            images: [
                { image: 'select', alt: 'Select food', text: 'Lorem, ipsum dolor.' },
                { image: 'chef', alt: 'Chef in the house', text: 'Lorem ipsum dolor sit.' },
                { image: 'delivery', alt: 'Fast delivery', text: 'Lorem ipsum dolor sit.' },
            ]
        }
    }
})